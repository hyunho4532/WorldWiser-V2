...
class ScheduleActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val scheduleAdapter = ScheduleAdapter(this, scheduleList, layoutInflater)
            ...
            .addOnSuccessListener { document ->
                ...
                findViewById<AppCompatButton>(R.id.btn_schedule_insert).setOnClickListener { view ->
                    ...
                    if (scheduleStatusViewModel.registerResult.value.toString().equals("true")) {
                        ...
                        bottomSheetTravelScheduleView.findViewById<NiceSwitch>(R.id.switcher_travel_schedule_check).setOnCheckedChangedListener { checked ->
                            if (checked) {
                                bottomSheetTravelScheduleView.findViewById<TextView>(R.id.switcher_travel_schedule_text).text = "진행 완료"
                            } else {
                                bottomSheetTravelScheduleView.findViewById<TextView>(R.id.switcher_travel_schedule_text).text = "진행 중"
                            }
                        }
                        ...
                        bottomSheetTravelScheduleView.findViewById<AppCompatButton>(R.id.btn_schedule_datePicker_insert).setOnClickListener {
                            ...
                            if (bottomSheetTravelScheduleView.findViewById<EditText>(R.id.et_travel_schedule_todo).text.toString().isEmpty()) {
                                ...
                                val schedule = hashMapOf(
                                    ...
                                    "status" to bottomSheetTravelScheduleView.findViewById<TextView>(R.id.switcher_travel_schedule_text).text.toString()
                                )
